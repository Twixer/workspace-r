# source : http://menugget.blogspot.fr/2014/01/gmt-standard-color-palettes.html
...
gmt.pals <- list(
    cool = c("#00FFFF", "#0DF2FF", "#19E6FF", "#26D9FF", 
...
#plot of palettes
png("data/gmt_palettes.png", width=6, height=10, units="in", res=400)
...
img <- readPNG("img/gmt_palettes.png")
